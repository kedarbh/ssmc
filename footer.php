        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="text-sm text-gray-400 space-y-2">
                    ...
                    <li><a href="/programs" class="hover:text-white transition">Academic Programs</a></li>
                    <li><a href="/notices" class="hover:text-white transition">Notices</a></li>
                </ul>
            </div>
            <div>
                <h3 class="text-xl font-bold mb-4 text-secondary">Contact Us</h3>
                <ul class="text-sm text-gray-400 space-y-2">
                    <li>📍 Ratnanagar, Chitwan, Nepal</li>
                    <li>📞 +977-9855062047</li>
                    <li>✉️ Shaheedsmriticampus@yahoo.com</li>
                </ul>
            </div>
            <div>
