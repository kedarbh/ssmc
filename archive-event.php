...
<div class="bg-gradient-to-br from-primary via-primary to-blue-900 py-16 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">Campus Events</h1>
        <p class="text-blue-100/70 mt-3 max-w-xl font-light text-lg">Upcoming and past events at Shaheed Smriti Multiple Campus.</p>
    </div>
</div>
            ...
            <main class="flex-1">
                ...
                <?php else : ?>
                    <div class="text-center bg-white rounded-xl p-16 shadow-sm border border-gray-100">
                        ...
                        <p class="mt-4 text-gray-500 text-lg">No events published yet.</p>
                    </div>
                <?php endif; ?>
            </main>
            ...
            <aside class="lg:w-80 flex-shrink-0">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sticky top-24 overflow-hidden group/sidebar hover:shadow-md transition-all duration-300">
                    ...
                    <h3 class="font-extrabold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-100 relative z-10">
                        <span class="text-xl">📅</span> Recent Events
                    </h3>
                    <ul class="space-y-4">
                        <?php
                            ...
                            while ($recent_events->have_posts()) : $recent_events->the_post(); ?>
                                <li>
                                    <a href="<?php the_permalink(); ?>" class="group block">
                                        <p class="text-sm font-bold text-gray-800 group-hover:text-primary transition-colors duration-200 line-clamp-2 leading-tight mb-1"><?php the_title(); ?></p>
                        ...
                        <?php endwhile;
                            ...
                            echo '<li class="text-sm text-gray-500">No recent events.</li>';
                        endif; ?>
                    </ul>
                </div>
            </aside>
